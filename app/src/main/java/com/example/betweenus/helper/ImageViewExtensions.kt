...
fun ImageView.loadImage(
    ...
    if (imageUrl.isNullOrEmpty()) {
        ...
        val requestBuilder =
            Glide.with(this).load(imageUrl).transition(DrawableTransitionOptions.withCrossFade())
        applyOptions?.let {
...
fun ImageView.loadPictureCircleCrop(
    ...
    Glide.with(context).load(url).circleCrop().error(
        Glide.with(context).load(errorDrawableRes).circleCrop()
    ).into(this)
}
...
fun ImageView.loadPictureCircleCrop(
    ...
    Glide.with(context).load(bitmap).circleCrop().error(
        Glide.with(context).load(errorDrawableRes).circleCrop()
    ).into(this)
}